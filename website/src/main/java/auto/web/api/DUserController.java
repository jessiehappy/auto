...
import auto.qr.service.user.IDUserService;
...
public class DUserController {
	...
	public String login(HttpServletRequest request,HttpServletResponse response){
		...
		try {
			DUser user=duserService.getDUser(telephone);
			if(user!=null){
	...
	public String subDUser(HttpServletRequest request,HttpServletResponse response){
		...
		try {
			DAuth dauth=duserService.createDAuth(username,telephone,address,company,businessLicence,
