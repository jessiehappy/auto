...
public class CUserDaoImpl extends DaoImpl implements ICUserDao {
	...
	@Override
	public List<CUser> getCUsers(Collection<String> usernames) {
		if (CollectionUtils.isEmpty(usernames)) {
            return Collections.emptyList();
        }
        List<CUser> results = (List<CUser>)getSession().createCriteria(CUser.class)
