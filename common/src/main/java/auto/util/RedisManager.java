...
public class RedisManager {
    ...
    private static final String ONLINE_HOST = "9c1c0aeda123424a.m.cnbja.kvstore.aliyuncs.com";
    
    private static final String ONLINE_PASSWORD = "107rooMadmin";
    ...
    static {
        ...
        if (Properties.isOnline) {
            pool = new JedisPool(config, ONLINE_HOST, Protocol.DEFAULT_PORT, Protocol.DEFAULT_TIMEOUT, ONLINE_PASSWORD);
        } else {
